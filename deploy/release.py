...
def release(release_context):
    ...
    starting_version = release_context.package_version()
    package_name = release_context.package_name()
    print("Starting version for release is {}. Package name is {}.".format(starting_version, package_name))
...
def bump_version(release_context):
    starting_version = release_context.package_version()
    print("Bumping version starting version = {}.".format(starting_version))
...
class ReleaseContext:
    def __init__(
        ...
        # A dictionary-like container holding the values from the cargo_file.
        self._cargo_content = self.read_cargo_file()
    ...
    def package_version(self):
        return self._cargo_content['package']['version']

    def package_name(self):
        return self._cargo_content['package']['name']

    def read_cargo_file(self):
        with open(self.cargo_file) as cargo_file:
            return contoml.loads(cargo_file.read())
